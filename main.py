...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.top_camera = CameraFeed('yolov4-tiny-detector_best-topview-v2.weights', 'yolov4-tiny-detector-topview-v2.cfg', 'top-detection.names', 0, 'top',"tinyYolo")
        ...
        self.left_camera = CameraFeed('yolov4-tiny-detector_best-sideview-v2.weights', 'yolov4-tiny-detector-sideview-v2.cfg', 'sideview.names', 1, 'left',"tinyYolo")
        ...
        self.right_camera = CameraFeed('yolov4-tiny-detector_best-sideview-v2.weights', 'yolov4-tiny-detector-sideview-v2.cfg', 'sideview.names', 3, 'right',"tinyYolo")
    ...
    def tinyYoloCheck(self):
        ...
        self.notification_label.setText('Tiny Yolo')
